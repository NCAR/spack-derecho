...
export LMOD_PACKAGE_PATH=/glade/u/apps/derecho/25.10/envs/public/util
export LMOD_CONFIG_DIR=/glade/u/apps/derecho/25.10/envs/public/util
export LMOD_AVAIL_STYLE=grouped:system

# Location of Lmod initialization scripts
export LMOD_ROOT=/glade/u/apps/derecho/25.10/spack/opt/spack/lmod/8.7.55/gcc/12.5.0/uncg
...
export LMOD_MODULERCFILE=/glade/u/apps/derecho/25.10/envs/public/util/hidden-modules
