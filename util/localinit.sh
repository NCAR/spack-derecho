...
export LMOD_PACKAGE_PATH=/glade/u/apps/derecho/24.12/envs/public/util
export LMOD_CONFIG_DIR=/glade/u/apps/derecho/24.12/envs/public/util
export LMOD_AVAIL_STYLE=grouped:system

# Location of Lmod initialization scripts
export LMOD_ROOT=/glade/u/apps/derecho/24.12/spack/opt/spack/lmod/8.7.37/gcc/12.4.0/nr3e
...
export LMOD_MODULERCFILE=/glade/u/apps/derecho/24.12/envs/public/util/hidden-modules
