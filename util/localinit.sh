...
export LMOD_SYSTEM_DEFAULT_MODULES="ncarenv/23.05:craype/2.7.20:intel/2023.1.0:ncarcompilers/1.0.0:cray-mpich/8.1.25:netcdf/4.9.2"
export MODULEPATH=/glade/u/apps/derecho/modules/environment

# Location of Lmod initialization scripts
export LMOD_ROOT=/glade/u/apps/derecho/23.05/spack/opt/spack/lmod/8.7.20/gcc/7.5.0
...
export LMOD_MODULERCFILE=/glade/work/csgteam/spack-deployments/derecho/23.05/envs/public/util/hidden-modules
